...
class ExtensiveRolesChecker(object):
    ...
    def _generate(self):
        for entity in self._json_file['items']:
            ...
            if 'rules' in entity and entity['rules'] is not None:
                ...
                print(f"No rules found for entity: {role_name}")
    ...
    def high_risk_roles(self, rule, role_name):
        ...
        resources_attributes = ['deployments','daemonsets','statefulsets','rextensiveClusterRolesCheckereplicationcontrollers','replicasets','jobs','cronjobs']
